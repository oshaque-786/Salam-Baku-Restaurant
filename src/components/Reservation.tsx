        ...
        {!reservationEnabled ? (
          ...
          >
            ...
            <h3 className="text-2xl font-bold font-heading mb-3">
              Online Reservations Temporarily Unavailable
            </h3>
            <p className="text-white/70 max-w-lg mx-auto mb-6">
              Online reservations are currently turned off. However, you can
              still request a table by contacting us directly via WhatsApp.
            </p>
            <button
              type="button"
              onClick={handleCancelClick}
              className="px-8 py-4 bg-brand-accent text-white font-bold rounded-full hover:bg-brand-accent/80 transition-all shadow-lg shadow-brand-accent/20"
            >
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-white/60">
                ...
                <button
                  type="button"
                  onClick={handleCancelClick}
                  className="text-brand-accent hover:text-white transition-colors focus:outline-none underline"
                >
                  Cancel via WhatsApp
                </button>
              </p>
