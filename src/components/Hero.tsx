        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-white/70 max-w-lg mb-8 leading-relaxed font-sans">
              ...
              dining. Authentic Biryani, sizzling BBQ, rich Karahi, and more,
            ...
            <div className="flex flex-wrap gap-4">
              <a
                href="#menu"
                className="px-8 py-4 bg-brand-neon text-brand-dark font-bold rounded-full hover:bg-white transition-all flex items-center gap-2 group box-glow"
              >
                Order Delivery
              ...
              <a
                href="#reservation"
                className="px-8 py-4 bg-transparent border-2 border-brand-accent text-white font-bold rounded-full hover:bg-brand-accent/20 transition-all flex items-center justify-center shadow-[0_0_15px_rgba(139,28,49,0.4)]"
              >
                Reserve Table
              </a>
            </div>
