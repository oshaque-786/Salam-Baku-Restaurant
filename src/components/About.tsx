...
const aboutData = [
  {
    ...
    items: ['Wheelchair accessible entrance', 'Wheelchair accessible parking lot']
  },
  {
  ...
  },
  {
    ...
    items: ['Great beer selection', 'Great cocktails', 'Great coffee', 'Great dessert', 'Great tea selection', 'Great wine list', 'Live music', 'Rooftop seating']
  },
  {
  ...
  },
  {
    ...
    items: ['Alcohol', 'Beer', 'Cocktails', 'Coffee', 'Halal food', 'Happy hour food', 'Hard liquor', 'Late-night food', 'Organic dishes', 'Quick bite', 'Small plates', 'Vegan options', 'Vegetarian options', 'Wine']
  },
  {
    category: 'Dining options',
    icon: <Clock className="w-5 h-5 text-brand-neon" />,
    items: ['Breakfast', 'Brunch', 'Lunch', 'Dinner', 'Counter service', 'Dessert', 'Seating', 'Table service']
  },
  {
    category: 'Amenities',
  ...
  },
  {
    ...
    items: ['Free parking lot', 'Free street parking', 'Paid street parking', 'Usually plenty of parking']
  },
  {
    category: 'Pets',
...
export default function About() {
  return (
    <section id="about" className="py-24 bg-brand-dark relative z-10 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/60 max-w-2xl mx-auto">
            Everything you need to know about dining at Salam Baku. From our amenities to our atmosphere, we ensure every detail of your visit is perfect.
          </p>
        </motion.div>
          ...
          {aboutData.map((section, idx) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-heading font-bold text-lg text-white">{section.category}</h3>
              </div>
