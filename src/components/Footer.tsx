...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="bg-[#050f1d] border-t border-white/5 pt-16 pb-8"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="text-white/60 mb-6 text-sm leading-relaxed">
              Serving the finest culinary fusions in the heart of Baku.
              Delivering joy, one plate at a time.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                aria-label="Facebook"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-neon hover:text-brand-dark transition-all"
              >
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70">
              ...
              <li className="flex items-start gap-3 pt-2">
                ...
                <span>
                  Spacious dining for up to <strong>60 persons</strong>
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70">
              ...
              <li className="mt-4 p-3 bg-brand-neon/10 border border-brand-neon/20 rounded-lg">
                <p className="text-brand-neon text-xs font-semibold uppercase tracking-wider text-center">
                  Open Daily
                </p>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-xs">
            © {new Date().getFullYear()} Salam Baku Restaurant. All rights
            reserved.{" "}
            <a
              href="#admin"
              className="ml-2 hover:text-brand-neon transition-colors opacity-50"
            >
              Staff Login
            </a>
          </p>
