        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/70 mb-6 leading-relaxed">
              At Salam Baku, we believe that exceptional food starts with
              uncompromising quality. We weave the rich essence of historic
              spice routes—echoing the complexity of Sindhi Ajrak motifs in our
              culinary philosophy—with locally sourced Azerbaijani ingredients.
            </p>
            <p className="text-white/70 mb-8 leading-relaxed">
              Whether you're craving the smoky perfection of live BBQ or the
              aromatic depth of a slow-cooked Biryani, every plate is prepared
              to deliver an unforgettable dining experience.
            </p>

            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <div className="p-1 rounded-full bg-brand-neon/20 text-brand-neon">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="font-medium text-white/90">
                  Comfortable seating arrangements for up to 60 guests
                </span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="font-medium text-white/90">
                  100% Fresh, locally sourced produce and halal meats
                </span>
              </li>
              <li className="flex items-center gap-3">
                <div className="p-1 rounded-full bg-brand-accent/20 text-brand-accent">
                  <BadgeCheck className="w-5 h-5" />
                </div>
                <span className="font-medium text-white/90">
                  Top-rated hygiene and food safety standards
                </span>
              </li>
            </ul>
          </motion.div>
